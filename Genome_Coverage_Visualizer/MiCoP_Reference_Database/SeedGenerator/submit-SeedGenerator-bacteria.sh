...
dataDir="/u/scratch2/scratch1/d/dkim/NCBI-RefSeq_filtered/bacteria"
dataDirBasename=`basename $dataDir`		#bacteria			
dataDir="$dataDir/"						
...
do
	...
	then
		...
		then
			...
			# sort /u/scratch2/scratch2/m/malser/NCBI-RefSeq_filtered_Seeds/archaea.1.1.fasta | uniq -c |wc -l
		fi
	fi
done
