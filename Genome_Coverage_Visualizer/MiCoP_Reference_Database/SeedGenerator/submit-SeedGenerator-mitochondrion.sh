#!/bin/sh
#$ -S /bin/bash
#$ -N job-Seed-Generator-mitochondrion-malser
#$ -cwd
#$ -M mealser@gmail.com
#$ -m abe
...
dataDir="/u/scratch2/scratch1/d/dkim/NCBI-RefSeq_filtered/mitochondrion"
dataDirBasename=`basename $dataDir`		#mitochondrion			
dataDir="$dataDir/"						
...
do
	...
	then
		...
		then
			...
			# sort /u/scratch2/scratch2/m/malser/NCBI-RefSeq_filtered_Seeds/mitochondrion.1.1.fastq | uniq -c |wc -l
		fi
	fi
done
