#!/bin/sh
#$ -S /bin/bash
#$ -N job-Seed-Generator-vertebrate_other-malser
#$ -cwd
#$ -M mealser@gmail.com
#$ -m abe
...
dataDir="/u/scratch2/scratch1/d/dkim/NCBI-RefSeq_filtered/vertebrate_other"
dataDirBasename=`basename $dataDir`		#vertebrate_other			
dataDir="$dataDir/"						
...
do
	...
	then
		...
		then
			...
			# sort /u/scratch2/scratch2/m/malser/NCBI-RefSeq_filtered_Seeds/vertebrate_other.1.1.fastq | uniq -c |wc -l
		fi
	fi
done
