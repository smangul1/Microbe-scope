#!/bin/sh
#$ -S /bin/bash
#$ -N job-Seed-Generator-invertebrate-malser
#$ -cwd
#$ -M mealser@gmail.com
#$ -m abe
...
dataDir="/u/scratch2/scratch1/d/dkim/NCBI-RefSeq_filtered/invertebrate"
dataDirBasename=`basename $dataDir`		#invertebrate			
dataDir="$dataDir/"						
...
do
	...
	then
		...
		then
			...
			# sort /u/scratch2/scratch2/m/malser/NCBI-RefSeq_filtered_Seeds/invertebrate.1.1.fasta | uniq -c |wc -l
		fi
	fi
done
