#!/bin/sh
#$ -S /bin/bash
#$ -N job-Seed-Generator-plant-malser
#$ -cwd
#$ -M mealser@gmail.com
#$ -m abe
...
dataDir="/u/scratch2/scratch1/d/dkim/NCBI-RefSeq_filtered/plant"
dataDirBasename=`basename $dataDir`		#plant			
dataDir="$dataDir/"						
...
do
	...
	then
		...
		then
			...
			# sort /u/scratch2/scratch2/m/malser/NCBI-RefSeq_filtered_Seeds/plant.1.1.fasta | uniq -c |wc -l
		fi
	fi
done
